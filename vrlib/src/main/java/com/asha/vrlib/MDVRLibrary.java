...
public class MDVRLibrary {
    ...
    // interactive mode
    public static final int INTERACTIVE_MODE_MOTION = 4;
    public static final int INTERACTIVE_MODE_TOUCH = 2;
    public static final int INTERACTIVE_MODE_MOTION_WITH_TOUCH = 3;
        public static final int INTERACTIVE_MODE_CARDBORAD_MOTION = 1;
    public static final int INTERACTIVE_MODE_CARDBORAD_MOTION_WITH_TOUCH = 5;

    // display mode
    public static final int DISPLAY_MODE_NORMAL = 102;
    public static final int DISPLAY_MODE_GLASS = 101;
