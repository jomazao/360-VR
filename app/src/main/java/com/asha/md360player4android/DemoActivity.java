...
public class DemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data.put(data.size(), Environment.getExternalStorageDirectory() + File.separator + "360Videos/f1.mp4");
        data.put(data.size(), Environment.getExternalStorageDirectory() + File.separator + "360Videos/f2.mp4");
        data.put(data.size(), Environment.getExternalStorageDirectory() + File.separator + "360Videos/full2.mp4");
